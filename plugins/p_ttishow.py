...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        if message.chat.id in temp.BANNED_CHATS:
            ...
            buttons = [[
                InlineKeyboardButton('🌐 Support', url=f'https://t.me/CINEMAHUB_NEW_MOVIES')
            ]]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('📢 Updates', url='https://t.me/CINEMAHUB_NEW_MOVIES')
        ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                ...
                video="https://telegra.ph/file/5104288cec4e13769a882.mp4",                                               
                                                 ...
                                                 reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('➡️ɢʀᴏᴜᴘ ʀᴜʟᴇs⬅️', url='https://t.me/CINEMAHUB_NEW_MOVIES') ] ] )
                )
